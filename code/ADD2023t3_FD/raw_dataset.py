    ...
    def __init__(self, access_type, path_to_database, path_to_protocol, part='train'):
        ...
        if self.part == 'train':
            protocol = os.path.join(
                os.path.join(self.path_to_protocol, 'ASVspoof2019.' + access_type + '.cm.' + self.part + '.trn.txt'))
        else:
...
class ADD2023(Dataset):
    def __init__(self, path_to_database, path_to_protocol, part='train'):
        ...
        self.ptd = path_to_database
        self.part = part
        self.path_to_audio = os.path.join(self.ptd, self.part + '/wav')
        self.path_to_protocol = path_to_protocol
...
class ADD2023_eval(Dataset):
    def __init__(self):
        super(ADD2023_eval, self).__init__()
        self.path_to_audio = '/home/chenghaonan/xieyuankun/data/ADD2023track3/eval/wav'
        self.path_to_protocol = '/home/chenghaonan/xieyuankun/data/ADD2023track3/eval/label.txt'
...
class ADD2023_eval_train(Dataset):
    def __init__(self):
        super(ADD2023_eval_train, self).__init__()
        self.path_to_audio = '/home/chenghaonan/xieyuankun/data/ADD2023track3/train/wav'
        self.path_to_protocol = '/home/chenghaonan/xieyuankun/data/ADD2023track3/label/train.txt'
        with open(self.path_to_protocol, 'r') as f:
            audio_info = [info.strip().split() for info in f.readlines()]
            self.all_info = audio_info
...
class ADD2023_eval_eval(Dataset):
    def __init__(self):
        super(ADD2023_eval_eval, self).__init__()
        self.path_to_audio = '/home/chenghaonan/xieyuankun/data/ADD2023track3/eval/wav'
        self.path_to_protocol = '/home/chenghaonan/xieyuankun/data/ADD2023track3/eval/label.txt'
        with open(self.path_to_protocol, 'r') as f:
            audio_info = [info.strip().split() for info in f.readlines()]
...
class VCC2020Raw(Dataset):
    def __init__(self, path_to_spoof="/data2/neil/nii-yamagishilab-VCC2020-listeningtest-31f913c",
                 path_to_bonafide="/data2/neil/nii-yamagishilab-VCC2020-database-0b2fb2e"):
...
class ASVspoof2015Raw(Dataset):
    def __init__(self, path_to_database="/data/neil/ASVspoof2015/wav",
                 path_to_protocol="/data/neil/ASVspoof2015/CM_protocol", part='train'):
...
class ASVspoof2019LARaw_withTransmission(Dataset):
    def __init__(self, path_to_database="/data/shared/LA_aug",
                 path_to_protocol="/data/neil/DS_10283_3336/LA/ASVspoof2019_LA_cm_protocols/", part='train'):
...
class ASVspoof2019LARaw_withTransmissionAndDevice(Dataset):
    def __init__(self, path_to_database="/data/shared/LAPA_aug",
                 path_to_protocol="/data/neil/DS_10283_3336/LA/ASVspoof2019_LA_cm_protocols/", part='train'):
...
class ASVspoof2019DFRaw_withCompression(Dataset):
    def __init__(self, path_to_database="/data/shared/DF_aug",
                 path_to_protocol="/data/neil/DS_10283_3336/LA/ASVspoof2019_LA_cm_protocols/", part='train'):
...
class ASVspoof2019DFRaw_withCompressionAndDevice(Dataset):
    def __init__(self, path_to_database="/data/shared/DFPA_aug",
                 path_to_protocol="/data/neil/DS_10283_3336/LA/ASVspoof2019_LA_cm_protocols/", part='train'):
