...
def knn_score(feas_train, feas, k=6, min=False):
...
class Mahalanobis(object):
    def __init__(self, normalize_on=True, standardize_on=True, num_clusters=6):
    ...
    def fit(self, X, y=None):
        ...
        if supervised:
            ...
            if self.num_clusters > 1:
                kmeans = faiss.Kmeans(d=X.shape[1], k=self.num_clusters, niter=1000, verbose=False, gpu=False)
